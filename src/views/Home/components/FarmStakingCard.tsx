    ...
    const tokenAdded = await window.ethereum.request({
      ...
      params: {
        ...
        options: {
          ...
          image: `https://xhash.farm/images/token.png`,
        },
      },
    })
      ...
      <CardBody>
        ...
        <Actions>
          ...
          <Flex >
            ...
            >
              {pendingTx ? t('Collecting XSH') : t(`Harvest all %farm%`, { farm : numFarmsToCollect })}
            </Button>
            <Button 
            target="_blank"
            as='a' href="/swap">
