...
const CakeStats = () => {
  ...
  const rewardPerBlock = farms && farms.data ? farms.data[0].xhashperblock : 0
    ...
    <StyledCakeStats>
      <CardBody>
        ...
        <Row>
          ...
          {totalSupply && <CardValue fontSize="14px" value={100000} decimals={0} />}  
        </Row>
        <Row>
        ...
        <Row>
          <Text fontSize="14px">{t('Rewards XSH/block')}</Text>
