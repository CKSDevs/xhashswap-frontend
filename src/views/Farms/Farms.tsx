...
const Farms: React.FC<FarmsProps> = (farmsProps) => {
  ...
  console.log('debug->farmsLP', farmsLP)
    ...
    (farmsToDisplay: Farm[]): FarmWithStakedValue[] => {
      let farmsToDisplayWithAPR: FarmWithStakedValue[] = farmsToDisplay.map((farm) => {
        ...
        const { cakeRewardsApr, lpRewardsApr } = isActive
          ? getFarmApr(new BigNumber(farm.poolWeight), cakePrice, totalLiquidity, farm.lpAddresses[ChainId.MAINNET], new BigNumber(farm.xhashperblock))
            ...
            <Flex flexDirection="column" flex="1" alignSelf={['flex-start', null, null, 'center']}>
              ...
              <Flex>
                <Heading scale="lg" color="text">
                  {tokenMode ? t('Stake Single token to earn XSH') : t('Stake LP tokens to earn XSH')}
                </Heading>
              </Flex>
            </Flex>
