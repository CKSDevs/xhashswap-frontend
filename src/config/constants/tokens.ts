...
export const XSH: { [chainId: number]: Token } = {
  [ChainId.MAINNET]: new Token(
    ChainId.MAINNET,
...
const tokens = {
  ...
  xsh: {
    symbol: 'XSH',
    address: {
      56: '0xb30B27aDb3B0A45e88385eB2BB144Fad9120A420',
      97: '',
    },
    decimals: 18,
    projectLink: 'https://xhash.farm/'
  },
  xmine: {
    symbol: 'X-MINE',
    address: {
  ...
  evoc: {
    symbol: 'EVOC',
    address: {
      56: '0x086CC8e468B3cB5494F18a7aBc2De1321306aF12',
      97: '',
    },
    decimals: 18,
